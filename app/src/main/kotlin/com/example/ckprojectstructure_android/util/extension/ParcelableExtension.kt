...
inline fun <reified T> parcelableClassLoaderCreator(
    ...
    object : Parcelable.ClassLoaderCreator<T> {
        ...
        override fun createFromParcel(source: Parcel): T {
            return createFromParcel(source, T::class.java.classLoader!!)
        }
...
inline fun Parcel.readExtBoolean() = readInt() != 0

inline fun Parcel.writeExtBoolean(value: Boolean) = writeInt(if (value) 1 else 0)
